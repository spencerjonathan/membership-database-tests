...
(54, 5, 'Freddy', 'Blogsy', 'Mr', 1, 'No', '16-70', 0, '01234 567 890', 'freddy@blogsy.com', 'Email', 0, '', '1 School Lane', 'Blogs Towers', 'Fred Village', 'London', '', 'EC1 ABC', '', '11-Feb-11', '11-Feb-11', NULL, NULL, 1, 0, 0, NULL),
...
ALTER TABLE `c1jr0_md_member` CHANGE `insurance_group` `insurance_group` VARCHAR(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL;
update c1jr0_md_member 
inner join c1jr0_users u on u.username = "Jon"
